const SECURITY_HEADERS={
  ...
  "Content-Security-Policy":"default-src 'self'; img-src 'self' https://cnfanssp.com https://*.google-analytics.com data:; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com; connect-src 'self' https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com; form-action 'self' https://cnfanssp.com; base-uri 'self'; frame-ancestors 'self'"
};
