const SECURITY_HEADERS={
  ...
  "Content-Security-Policy":"default-src 'self'; img-src 'self' https://cnfanssp.com data:; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com; form-action 'self' https://cnfanssp.com; base-uri 'self'; frame-ancestors 'self'"
};
